...
def split_into_tweets(long_text, limit=280):
    """
    Splits long_text into a list of strings, each ≤ limit characters, breaking at word boundaries when possible.
    """
    import textwrap
    return textwrap.wrap(long_text, limit)
